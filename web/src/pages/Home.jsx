        ...
        <section>
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div class="mr-auto place-self-center lg:col-span-7">
                    ...
                    <p class="max-w-2xl mb-6 text-black lg:mb-8 md:text-lg lg:text-xl">Txtpods lets you read along with your favorite shows. Whether you are hard of hearing, want to learn a new language, or just prefer reading over listening, full transcripts are available for you with a single click of a button.</p>
